...
3. Run `npm install` after resolving conflicts
...
<div class="flex flex-wrap gap-3 mt-4">
  <Button href="/docs/getting-started" variant="primary" icon="mdi:rocket-launch">Getting Started</Button>
  <Button href="/docs/core-concepts" variant="secondary" icon="mdi:book-open-page-variant">Core Concepts</Button>
  <Button href="/docs/components" variant="secondary" icon="mdi:puzzle">Components</Button>
</div>
