...
<Button href="/docs/getting-started" variant="glass" icon="mdi:rocket-launch">Getting Started</Button>
<Button href="/docs/core-concepts" variant="glass" icon="mdi:book-open-page-variant">Core Concepts</Button>
<Button href="/docs/components" variant="glass" icon="mdi:puzzle">Components</Button>
