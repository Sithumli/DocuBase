...
<div class="flex flex-wrap gap-3 mt-4">
  ...
  <Button href="/docs/core-concepts" variant="primary" icon="mdi:book-open-page-variant">Core Concepts</Button>
  <Button href="/docs/components" variant="primary" icon="mdi:puzzle">Components</Button>
</div>
